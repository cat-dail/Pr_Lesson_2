...
# Для избежания некорректного вывода запускайте линейный вызов и многопроцессный по отдельности, п
# редварительно закомментировав другой.
#
...
# Линейный вызов
# a1 = read_info('file 1.txt')
# a2 = read_info('file 2.txt')
# a3 = read_info('file 3.txt')
# a4 = read_info('file 4.txt')
