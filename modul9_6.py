...
def all_variants(text):
    for i in range(len(text)): #  элемент  по длине строки text
        for j in range(len(text)-i): # элемен из строки text уменьшенной на i
            g = 1
            yield text[j:j+i+g]      # генератор, g -шаг итерации
            g += 1
